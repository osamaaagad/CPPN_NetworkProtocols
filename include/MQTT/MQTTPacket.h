...
typedef union
{
 ...
 struct __attribute__((__packed__)) MQTTLenString
{
	int len;
	char* data;
};
typedef struct MQTTLenString MQTTLenString;

struct __attribute__((__packed__))MQTTString
{
	char* cstring;
	MQTTLenString lenstring;
} ;
typedef struct MQTTString MQTTString;
